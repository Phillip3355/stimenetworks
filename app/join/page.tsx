        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.timelineGrid}>
            ...
            <article className={styles.timelineCard}>
              ...
              <p className={styles.timelineText}>
                {t(
                  '• 카카오톡 오픈채팅방 (필수 가입)\n  : Stime 161 (서버 전체 긴급 공지 및 주요 소통을 위해 필수로 참여해야 합니다.)\n\n• 공식 디스코드 (선택 가입)\n  : discord.gg/stimenetworks (서버 이벤트 참여 및 타 플레이어와 음성 대화 등을 위해 선택적으로 가입할 수 있습니다.)',
                  '• KakaoTalk Open Chat (Mandatory)\n  : Stime 161 (Required to join for server announcements and official communication.)\n\n• Official Discord (Optional)\n  : discord.gg/stimenetworks (Optional to join for server events and general chat.)'
                )}
              </p>
            </article>
          </div>
